...
<svg xmlns="http://www.w3.org/2000/svg" width="92" height="20">
  ...
  <g mask="url(#a)">
    <path fill="#555" d="M0 0 h42 v20 H0 z" />
    <path fill="#4c1" d="M42 0 h50 v20 H42 z" />
    <path fill="url(#b)" d="M0 0 h92 v20 H0 z" />
  </g>
  <g fill="#fff" font-family="Open Sans" font-size="11">
    <text x="6" y="15" fill="#010101" fill-opacity=".3">badge</text>
    <text x="6" y="14">badge</text>
    <text x="46" y="15" fill="#010101" fill-opacity=".3">kloud51</text>
    <text x="46" y="14">kloud51</text>
  </g>
</svg>
"""
